<template>
    <AnimatedContent :distance="50" direction="horizontal" :reverse="props.reverseAnimationDirection" :duration="1.1"
        ...
        <Magnet class="m-[3vh] md:m-[4vw] lg:m-[5vw] ml-0 mr-0" :padding="200" :disabled="false" :magnet-strength="30"
            ...
            <SpotlightCard
                class-name="custom-spotlight-card h-auto min-h-[8.5em] md:min-h-[20vw] w-[90vw] md:w-[90vw] lg:w-[85vw] hg:w-[75vw] flex-col md:flex-row p-0 color-on-hover bg-dark-850 max-w-[2500px] md:max-h-[630px] text-[70%]"
